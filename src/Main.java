...
import Service.ServicesImpl.BookImpl;
import Service.ServicesImpl.LibraryImpl;
import Service.ServicesImpl.ReaderImpl;
import models.Book;
                                    ...
                                    switch (scanner1.nextInt()) {
                                        case 1:
                                            try {
                                                ...
                                                System.out.println(bookService.saveBook(ID, new Book(idBook, name, author, genre1)));
                                        ...
                                        case 2:
                                            try {
                                                ...
                                                System.out.println(bookService.getBookById(libraryId, getId));
                                            } catch (Exception e) {
                                                System.out.println("Ошибка: " + e.getMessage());
                                                scanner.nextLine();
                                            }
                                        ...
                                        case 3:
                                            try {
                                                ...
                                                System.out.println(bookService.getAll(scanner1.nextLong()));
                                            } catch (Exception e) {
                                                System.out.println("Ошибка: " + e.getMessage());
                                                scanner.nextLine();
                                            }
                                        ...
                                        case 4:
                                            try {
                                                ...
                                                System.out.println(bookService.deleteBook(library, delBook));
                                            } catch (Exception e) {
                                                System.out.println("Ошибка: " + e.getMessage());
                                                scanner.nextLine();
                                            }
                                    ...
                                    switch (scanner.nextInt()) {
                                        ...
                                        case 3:
                                            try {
                                                ...
                                                System.out.println(readerService.getReaderById(scanner1.nextLong()));
                                            } catch (Exception e) {
                                                System.out.println("Ошибка: " + e.getMessage());
                                                scanner.nextLine();
                                            }
